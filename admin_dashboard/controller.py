...
async def fire_push_notification(course_obj, category_obj, topic_obj, saved_obj, title, message):
    ...
    # registration_ids = [
    #     "cg8qvl2dT-22NhhHwqO3ve:APA91bEYZC-k4Vhc24pgA6S_f4qG9goQPw3W-LFdDzagyD2UInYFozKD3QZO_ucjh7Oj6ewS4mO51Voj7tvK1TIbwtFIgLRxexEKrqnA8Yvk003pNOZ01GZ9WjVx0LpKFacIizmLsvPO"]
